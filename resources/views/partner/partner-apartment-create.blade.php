        ...
        <form method="POST" action="#" class=" p-6 rounded-lg  space-y-6" enctype="multipart/form-data">
                    ...
                    <div x-data="{ selected: '', sameAddress: 'yes', propertyCount: 2 }" class="max-w-xl mx-auto p-4 space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <label
                                ...
                                <input type="radio" name="apartment_type" value="one" x-model="selected"
                                    class="hidden" />
                            </label>
                            ...
                            <label
                                ...
                                <input type="radio" name="apartment_type" value="multiple" x-model="selected"
                                    class="hidden" />
                            </label>
                        </div>
            ...
            <div x-show="step === 2" x-cloak>
                <div class="bg-white max-w-2xl w-full p-6 rounded-lg shadow text-center">
                    ...
                    <template x-if="step === 2">
                        <div class="space-y-2">
                            <button @click="step++"
                                class="w-full bg-[#3CC0E9] hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded">
                                Continue
                            </button>
                            <button @click="step--"
                                class="w-full border border-[#3CC0E9] text-[#3CC0E9] hover:bg-blue-50 font-semibold py-2 px-4 rounded mb-6">
                ...
                <div x-data="{
                    ...
                    <div x-show="showImportSection" x-transition class="border-t pt-6 space-y-4">
                        ...
                        <div x-data="{ url: '' }" class="flex gap-2">
                            ...
                            <button type="button" class="px-4 py-2 rounded"
                                :class="url ? 'bg-blue-500 text-white cursor-pointer hover:bg-blue-600' :
                    ...
                    <template x-if="step === 3">
                        <div class="flex items-center justify-between pt-4">
                            ...
                            <button type="button" @click="step++" :disabled="selectedChannels.length === 0"
            ...
            <div x-show="step === 4" x-cloak>
                <div x-data="{ substep: 1 }">
                    ...
                    <div
                        class="flex flex-wrap justify-between items-center border-b pb-4 mb-6 text-sm font-medium text-gray-700 mt-2">
                        <template
                            x-for="(label, index) in ['Basic Info', 'Property', 'Photos', 'Pricing', 'Legal Info', 'Review']">
                            <button class="py-1 px-3 rounded hover:bg-blue-100 transition"
                                :class="substep === index + 1 ? ' text-blue-600' : 'text-gray-700'"
                                @click="substep = index + 1" x-text="label">
                            </button>
                        </template>
                    </div>
                            ...
                            <section class="mb-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div class="md:col-span-2 flex">
                                        <div class="w-full bg-white p-6 rounded shadow-md flex flex-col">
                                            <label for="property_name" class="block text-gray-700">Property
                                                name</label>
                                        ...
                                        <div x-data="{ show: true }" x-show="show"
                                            ...
                                            <div class="flex items-center justify-between mb-2">
                                                <div class="flex items-center space-x-2">
                                                    <img src="{{ asset('assets/ei_like.svg') }}" alt="Help"
                                                        class="w-6 h-6 md:w-7 md:h-7 cursor-pointer" />
                                                    <h3 class="text-gray-700 text-sm">What should I consider when
                                                        choosing a name?</h3>
                                                </div>
                                        ...
                                        <div x-data="{ show: true }" x-show="show"
                                            ...
                                            <div class="flex items-center justify-between mb-2">
                                                <div class="flex items-center space-x-2">
                                                    ...
                                                    <h3 class="text-gray-700 text-sm">Why do I need to name my
                                                        property?</h3>
                                                </div>
                                                <button @click="show = false"
                                                    class="text-gray-500 hover:text-gray-700">
                                            ...
                                            <p class="text-sm text-gray-700">
                                                This is the name that will appear as the title of your listing. Be
                                                specific and avoid including private details.
                                            </p>
                                        </div>
                                ...
                                <div class="flex justify-between mt-6">
                                    ...
                                    <div class="flex justify-end mt-4">
                                        <button type="submit" @click="sub1step++"
                            ...
                            <div class="relative w-[1300px] h-[800px] overflow-hidden rounded-lg shadow mx-auto">
                                ...
                                <div class="relative z-10 flex items-center justify-start h-auto p-4 mt-[110px]">
                                    <div
                                        ...
                                        <h2 class="text-2xl font-semibold mb-4 text-gray-800">Where is your property?
                                        </h2>
                                        <form action="#" method="POST">
                                            <div class="mb-4">
                                                <label for="address"
                                                    class="block text-sm font-medium text-gray-700">Find your
                                                    address</label>
                                            ...
                                            <div class="mb-4">
                                                <label for="apartment"
                                                    class="block text-sm font-medium text-gray-700">Apartment or floor
                                            ...
                                            <div class="flex flex-col md:flex-row gap-4">
                                                ...
                                                <div class="flex-1">
                                                    <label for="postcode"
                                                        class="block text-sm font-medium text-gray-700">Post code / Zip
                                                        code</label>
                                            ...
                                            <div class="flex items-center mt-4">
                                                <input id="update_address" type="checkbox" name="update_address"
                                                    checked class="mr-2">
                                                <label for="update_address" class="text-sm text-gray-700">Update the
                                            ...
                                            <div x-data="{ showMessage: true }" x-show="showMessage"
                                                ...
                                                <span class="block sm:inline">Make sure the pin location is accurate
                                            ...
                                            <p class="text-sm text-gray-600 mt-2">
                                                Is the red pin location incorrect? Uncheck the option above and click or
                                                press on the map to move the pin.
                                            </p>
                                            <div class="flex justify-between mt-6">
                                                <!-- Back Button (Left) -->
                            ...
                            <section class="mb-12" x-data="{ channelManager: 'yes' }">
                                ...
                                <div class="bg-white p-4 max-w-2xl border border-gray-200 rounded mb-8">
                                    ...
                                    <p class="text-gray-700 mb-6">
                                        A channel manager is a third-party tool that lets you manage rates and
                                        availability across different sites you might list your place on, including
                                        {{ config('domains.subdomain') }}. If you're already using a channel manager, you can select 'Yes' to
                                    ...
                                    <div class="bg-white p-4 border border-gray-200 rounded mb-8 space-y-4">
                                        <!-- Yes Option -->
                                        <div>
                                            <input type="radio" id="yes" name="channel_manager"
                                                value="yes" class="mr-2" x-model="channelManager">
                                            ...
                                            <div class="bg-red-100 border border-red-300 rounded p-2">
                                                <div class="flex items-start text-sm text-red-700 space-x-2">
                                                    ...
                                                    <p>
                                                        ...
                                                        registration is complete – please continue to the next step.
                                                    </p>
                                                </div>
                                        ...
                                        <!-- No Option -->
                                        <div>
                                            <input type="radio" id="no" name="channel_manager"
                                                value="no" class="mr-2" x-model="channelManager">
                                    ...
                                    <div class="flex justify-between mt-6">
                                        ...
                                        <!-- Continue Button (Right) -->
                                        <button type="submit" @click="substep++"
                                            class="px-4 py-3 bg-[#3CC0E9] font-semibold text-white rounded hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-300">
                                            Continue
                                        </button>
                                    </div>
                    ...
                    <div x-show="substep === 3" x-cloak>
                        ...
                        <input type="file" name="property_photos" multiple class="w-full border p-2 rounded" />
                    </div>
                    ...
                    <div x-show="substep === 4" x-cloak>
                        ...
                        <input type="number" name="nightly_rate" class="w-full border p-2 rounded"
                            placeholder="e.g., 100" />
                    </div>
                    ...
                    <div x-show="substep === 5" x-cloak>
                        ...
                        <input type="text" name="legal_info" class="w-full border p-2 rounded"
                    ...
                    <!-- Substep Navigation -->
                    <div class="flex justify-between mt-6">
                        <button type="button" class="px-4 py-2 border rounded text-gray-700 hover:bg-gray-200"
                            x-show="substep > 1" @click="substep--">
                            Back
                        </button>
                        <button type="button" class="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700"
                            x-show="substep > 1 && substep < 6" @click="substep++">
                            Next
                        </button>
            ...
            <div x-show="step === 8" x-cloak>
                ...
                <textarea name="skills" rows="3" class="w-full border p-2 rounded" placeholder="List your skills" required></textarea>
            </div>
