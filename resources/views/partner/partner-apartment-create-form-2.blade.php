...
<body class="bg-gray-50 text-gray-800">
    ...
    <div x-data="{
                            ...
                            <template x-if="index === 0 && wizardStep <= 3">
                                <div
                                    ...
                                    <template x-for="i in 3">
                                        <div :class="wizardStep >= i ? 'bg-blue-600' : 'bg-gray-300'"
                                            class="h-1 flex-1 rounded-full"></div>
                                    </template>
                                </div>
                            </template>
        ...
        <div>
                ...
                <div class="max-w-5xl mx-auto px-4 py-10 space-y-32">
                    <section class="mb-8">
                            ...
                            <div class="flex flex-col gap-4">
                                    ...
                                    <div class="flex items-center justify-between mb-2">
                                        <div class="flex items-center space-x-2">
                                            <img src="{{ asset('assets/ei_like.svg') }}" alt="Help"
                                                class="w-6 h-6 md:w-7 md:h-7 cursor-pointer" />
                                            <h3 class="text-gray-700 text-sm">What should I consider when choosing a
                                                name?</h3>
                                        </div>
                                ...
                                <div x-data="{ show: true }" x-show="show"
                                    ...
                                    <p class="text-sm text-gray-700">
                                        This is the name that will appear as the title of your listing. Be specific and
                        ...
                        <div class="flex justify-between mt-6">
                            <!-- Back Button -->
                            <button type="button" @click="wizardStep > 1 ? wizardStep-- : null"
                            ...
                            <!-- Continue Button -->
                            <button type="button" @click="saveName()" :disabled="isLoading || !title.trim()"
                        ...
                        <div
                            ...
                            <div class="mb-4">
                                <label for="address" class="block text-sm font-medium text-gray-700">Find your
                                    address</label>
                                <input type="text" id="address" name="address" x-model="address"
                            ...
                            <div class="flex flex-col md:flex-row gap-4">
                                ...
                                <div class="flex-1">
                                    <label for="zipcode" class="block text-sm font-medium text-gray-700">Post code /
                                        Zip code</label>
                                    <input type="text" id="zipcode" name="zipcode" x-model="zipcode"
                                        class="mt-1 p-2 w-full border border-gray-300 rounded">
                                </div>
                            </div>
                        ...
                        <div x-show="channelManager === 'yes'" x-transition>
                            <div class="bg-red-100 border border-red-300 rounded p-2">
                                <div class="flex items-start text-sm text-red-700 space-x-2">
                                    ...
                                    <!-- Text block -->
                                    <p>
                                        Select 'Yes' only if you are already using a channel manager. You'll be able to
                                        connect your channel manager after your registration is complete – please
            ...
            <!-- Remaining Steps -->
            <template
                x-for="(label, index) in ['Property setup', 'Photos', 'Pricing and calendar', 'Legal information', 'Review and complete']"
                :key="index">
                <section x-show="wizardStep === index + 4" x-transition>
                    <div class="max-w-5xl mx-auto px-4 py-8">
                        <h2 class="text-2xl font-bold text-blue-700 mb-4" x-text="label"></h2>
                        <p class="text-gray-600">This is the content for <strong x-text="label"></strong>. Add your
                            actual form or wizard here.</p>
                        ...
                        <div class="flex justify-between mt-6">
                            ...
                            <!-- Continue Button -->
                            <button type="button" @click="wizardStep++" :disabled="wizardStep >= 6"
                                class="px-4 py-3 bg-[#3CC0E9] font-semibold text-white rounded hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-300 disabled:opacity-50 disabled:cursor-not-allowed">
    ...
    <div class="fixed bottom-4 right-4 bg-black bg-opacity-75 text-white p-2 rounded text-sm"
        x-text="'Current Step: ' + wizardStep"></div>
