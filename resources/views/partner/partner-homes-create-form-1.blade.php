            ...
            <template x-if="step === 3">
                <div>
                    ...
                    <section x-show="selectedBox === 3" class="mt-20 p-8 bg-gray-100 rounded shadow-lg">
                        ...
                        <button type="button" @click="step = 2" class="mt-4 bg-gray-300 px-4 py-2 rounded">
                            Back
                        </button>
                    </section>
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <h2 class="text-2xl font-semibold mb-4 text-gray-800">Where
                                                                is your property?</h2>
                                                            <form x-data="{ addressForm: {} }">
                                                                ...
                                                                <div class="mb-4">
                                                                    ...
                                                                    <select id="country"
                                                                        x-model="addressForm.country" name="country"
                                                                        class="mt-1 p-2 w-full border border-gray-300 rounded">
