                                        ...
                                        <div>
                                            ...
                                            <template x-if="step === 14 && selected === 'one'">
                                                <div x-data="{
                                                    commissionRate: 15,
                                                    getCurrencySymbol() {
                                                        const symbols = { 'LKR': 'Rs', 'USD': 'US$', 'EUR': '€', 'GBP': '£' };
                                                        return symbols[this.currency] || 'Rs';
                                                    },
                                                    getAdultPriceWithCommission() {
                                                        const basePrice = parseFloat(this.adultPrice || 0);
                                                        return basePrice + (basePrice * (this.commissionRate / 100));
                                                    },
                                                    getChildPriceWithCommission() {
                                                        const basePrice = parseFloat(this.childPrice || 0);
                                                        return basePrice + (basePrice * (this.commissionRate / 100));
                                                    },
                                                    getTotalPriceWithCommission() {
                                                        return this.getAdultPriceWithCommission() + this.getChildPriceWithCommission();
                                                    }
                                                }" class="max-w-5xl mx-auto px-4 py-8 space-y-6">

                                                    <h1 class="text-2xl font-bold">Set your pricing</h1>

                                                    <!-- Main Grid: 2 columns on larger screens -->
                                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">

                                                        <!-- Left: Pricing Form (2/3 width) -->
                                                        <div class="md:col-span-2 bg-white border rounded-lg p-6 shadow-sm space-y-4">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="text-sm text-gray-500 mt-2">Price per night for adults</p>
                                                            </div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="text-sm text-gray-500 mt-2">Price per night for children</p>
                                                            </div>

                                                            <!-- Commission Display -->
                                                            <div class="border-t pt-4 mt-4 space-y-2">
                                                                <p class="text-sm text-gray-600 mb-3">
                                                                    <span class="text-gray-500" x-text="commissionRate + '%'"></span> {{ config('domains.subdomain') }} commission
                                                                </p>

                                                                <div class="space-y-1 text-sm">
                                                                    <p class="text-gray-700">
                                                                        Adult price with commission:
                                                                        <span class="font-semibold" x-text="getCurrencySymbol() + ' ' + getAdultPriceWithCommission().toFixed(2)"></span>
                                                                    </p>
                                                                    <p class="text-gray-700" x-show="childPrice && parseFloat(childPrice) > 0">
                                                                        Child price with commission:
                                                                        <span class="font-semibold" x-text="getCurrencySymbol() + ' ' + getChildPriceWithCommission().toFixed(2)"></span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <!-- Right: Tip Box (1/3 width) -->
                                                        <div class="bg-white border rounded-lg p-4 shadow-sm text-sm text-gray-700 h-fit">
                                                            <div class="flex items-center gap-2 mb-2">
                                                                <svg class="w-5 h-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
                                                                    <path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z" />
                                                                </svg>
                                                                <strong class="font-semibold">What if I'm not sure about my price?</strong>
                                                            </div>
                                            ...
                                            <template x-if="step === 16 && selected === 'one'">
                                                <div>
                            ...
                            <script>
                                function wizard(selectedBoxValue) {
                                    return {
                                        ...
                                        currency: 'LKR', // Added for pricing step
                                        adultPrice: 0, // Added for pricing step
                                        childPrice: 0, // Added for pricing step
                                            ...
                                            if ((this.step === 1 && this.selected === 'one')) {
                                                ...
                                                if (!this.adultPrice || parseFloat(this.adultPrice) <= 0) {
                                                    Swal.fire({
                                                        ...
                                                        text: 'Please enter a valid adult price.',
                                                        toast: true,
                                                        position: 'top-end',
                                                        showConfirmButton: false,
                                                        timer: 3000
                                                ...
                                                fetch(`/partner/save-pricing/${this.propertyId}`, {
                                                    ...
                                                    .then(result => {
                                                        if (result.success) {
                                                            console.log('✅ Pricing saved:', result.data);
                                                            Swal.fire({
                                                                toast: true,
                                                                position: 'top-end',
                                                                icon: 'success',
                                                    ...
                                                    .catch(error => {
                                                        ...
                                                        Swal.fire({
                                                            icon: 'error',
                                                            title: 'Error',
                                                            text: 'Something went wrong while saving pricing.'
                                                        });
                                                    });
