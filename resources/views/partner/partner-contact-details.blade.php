            ...
            <form method="POST" action="{{ route('partner.register.contact') }}" id="contactForm">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="first_name" name="first_name" required
                        ...
                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-[#3CC0E9] focus:border-transparent focus:outline-none @error('first_name') border-red-500 @enderror" />
                    @error('first_name')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="last_name" name="last_name" required
                        ...
                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-[#3CC0E9] focus:border-transparent focus:outline-none @error('last_name') border-red-500 @enderror" />
                    @error('last_name')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    <label for="contact_number" class="block text-sm font-medium text-gray-800 mb-2">Phone number</label>
                    <div class="flex items-center border border-gray-300 rounded-lg px-3 py-2 space-x-2 @error('contact_number') border-red-500 @enderror">
                        <!-- Flag Image -->
                        ...
                        <select id="country-select" name="country_code"
                            class="bg-white border border-gray-300 rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[#3CC0E9] text-sm">
                        ...
                        <input type="tel" id="contact_number" name="contact_number" required
                            ...
                            class="flex-1 outline-none border-none focus:ring-0 text-gray-900 text-sm py-1" />
                    </div>
