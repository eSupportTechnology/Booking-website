    ...
    <div class="space-y-8">
        ...
        <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-8 text-white">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('partner.list-your-property') }}"
                    class="bg-white text-orange-600 px-6 py-3 rounded-xl font-semibold hover:bg-orange-50 transition-all duration-200 shadow-lg">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-lg">
            <form method="GET" class="flex flex-col md:flex-row gap-4">
                ...
                <button type="submit"
                    class="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-xl font-semibold transition-colors duration-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @empty
                <div class="col-span-full text-center py-12">
                    ...
                    <a href="{{ route('partner.list-your-property') }}"
                        class="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold transition-colors duration-200">
                        <i class="fas fa-plus mr-2"></i>Add Property
                    </a>
                </div>
            @endforelse
