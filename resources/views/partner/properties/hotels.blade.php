            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition property-row">
                        ...
                        <td class="px-4 py-3">
                            <div class="text-sm font-semibold text-green-600">${{ number_format($property['min_price_usd'] ?? 0, 2) }}</div>
        ...
        <div class="px-4 py-3 bg-gray-50 border-t border-gray-200">
            <div class="flex flex-col sm:flex-row justify-between items-center gap-3">
                <p class="text-sm text-gray-500">
                    Showing {{ $properties->firstItem() ?? 0 }} to {{ $properties->lastItem() ?? 0 }} of {{ $properties->total() }} hotel(s)
                </p>
