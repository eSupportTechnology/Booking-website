...
<section class="min-h-screen p-3 sm:p-4 bg-white rounded-lg shadow-lg">
    <div class="space-y-4 sm:space-y-6 p-2 sm:p-4">
        ...
        <!-- Title -->
        <h1 class="text-lg sm:text-2xl md:text-3xl font-bold text-gray-800 mb-2 sm:mb-4">Hotel Listings</h1>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-3 w-full">
            <div class="w-full sm:w-2/3 flex flex-col sm:flex-row gap-2">
                <input type="text" id="hotelSearchInput" placeholder="Search Hotels..."
        ...
        <div class="hidden sm:block bg-white rounded-lg shadow-lg border border-gray-100">
            <div class="overflow-x-auto">
                <table class="min-w-full text-xs sm:text-sm text-left text-gray-700" id="hotelsTable">
                    <thead class="bg-gray-50 text-[10px] sm:text-xs uppercase text-gray-500">
                        <tr>
                            ...
                            <th class="px-2 sm:px-4 py-2 sm:py-3">Hotel</th>
        ...
        <div class="sm:hidden grid grid-cols-1 gap-4">
            ...
            @empty
            <p class="text-center text-gray-500 col-span-1">No hotels found.</p>
            @endforelse
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function filterTable() {
        ...
        rows.forEach(row => {
            ...
            const hotelName = row.children[2]?.textContent.toLowerCase() || '';
            ...
            const matchesSearch = id.includes(searchTerm) || partnerName.includes(searchTerm) || hotelName.includes(searchTerm) || location.includes(searchTerm);
