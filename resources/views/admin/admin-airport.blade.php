...
<section class="min-h-screen p-4 bg-white rounded-lg shadow-lg">
    ...
    <div class="space-y-6 p-4">
        ...
        <!-- Title -->
        <h1 class="text-lg sm:text-2xl md:text-3xl font-bold text-gray-800 mb-3 sm:mb-6">Airport Transfers Management</h1>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            ...
            <div class="w-full sm:w-2/3 lg:w-2/3 flex gap-3">
                <input type="text" placeholder="Search by flight or passenger"
                ...
                <table class="min-w-full text-sm text-left text-gray-700" id="transfersTable">
                    ...
                    <tbody class="divide-y divide-gray-100 text-xs sm:text-sm">
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-2 sm:px-4 py-3 sm:py-4 text-gray-700">Alice Johnson</td>
                            <td class="px-2 sm:px-4 py-3 sm:py-4 text-gray-700">AI203</td>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-2 sm:px-4 py-3 sm:py-4 text-gray-700">Bob Smith</td>
                            <td class="px-2 sm:px-4 py-3 sm:py-4 text-gray-700">AI205</td>
                            <td class="px-2 sm:px-4 py-3 sm:py-4">
                                <div class="relative">
...
<script>
    function handleTransferStatusChange(selectEl, id) {
        ...
        console.log(`Changed status of Transfer ID ${id} to ${value}`);
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function filterTable() {
            ...
            rows.forEach(row => {
                ...
                const matchesSearch = searchTerm === '' || id.includes(searchTerm) || passenger.includes(searchTerm) || flight.includes(searchTerm);
