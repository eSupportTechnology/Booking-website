                ...
                <div class="space-y-4">
                    <div class="bg-white max-w-2xl w-full p-6 rounded-lg shadow mx-auto mt-16 px-4 md:px-6 lg:px-8 lg:ml-32">
                        <div class="max-w-xl mx-auto p-4 space-y-6">
                            ...
                            <!-- Only number input for multiple -->
                ...
                <div class="space-y-4">
                    <template x-if="selected === 'one'">
                         <div class="bg-white max-w-2xl w-full p-6 rounded-lg shadow text-center">
                            ...
                            <div class="flex justify-center mb-8">
                                <img src="{{ asset('images/tent-big@2x.png') }}" alt="One Property" class="w-16 h-16" />
                            </div>
                    ...
                    <template x-if="selected === 'multiple'">
                         <div class="bg-white max-w-2xl w-full p-6 rounded-lg shadow text-center">
                            <p class="text-base text-gray-600 mb-8">You're listing:</p>
                            <div class="flex justify-center mb-8">
                                <img src="{{ asset('images/tent-big@2x.png') }}" alt="Multiple Properties" class="w-16 h-16" />
                            </div>
...
<script>
    function wizardForm() {
        return {
            ...
            propertyCount: 2,
            categoryOptions: [
                { value: 'campsite', label: 'campsite', description: 'Accommodation offering cabins or bungalows alongside areas for camping or caravans with shared facilities or recreational activities', plural: 'campsites' },
                { value: 'boat', label: 'boat', description: 'Commercial travel accommodation located on a boat', plural: 'boats' },
                { value: 'luxury_tent', label: 'luxury tent', description: 'Tents with fixed bedding and some services, located in natural surroundings', plural: 'luxury tents' }
            ],
            get categoryLabel() {
            ...
            get categoryHeadingDescription() {
                switch (this.category) {
                    case 'campsite': return 'One campsite where guests can book an entire place';
                    case 'boat': return 'One boat where guests can book the entire place';
                    case 'luxury_tent': return 'One luxury tent where guests can book the entire place';
                    default: return 'One property in the same location where guests can book an entire apartment';
                }
            },
            get categoryHeadingDescriptionMultiple() {
                switch (this.category) {
                    case 'campsite': return 'Multiple campsites where guests can book an entire place';
                    case 'boat': return 'Multiple boats where guests can book the entire place';
                    case 'luxury_tent': return 'Multiple luxury tents where guests can book the entire place';
                    default: return 'Multiple properties available for guests';
                }
            },
            finalContinue() {
                let route = '';
