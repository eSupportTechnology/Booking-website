...
<div x-data="{ step: 1 }">
    ...
    <div class="px-4 py-6  w-full max-w-6xl mx-auto lg:ml-24 space-y-6">
        ...
        <section class="px-4 py-6 md:px-8 lg:px-16 flex justify-center" x-data="{
            ...
            <div class="w-full max-w-6xl">
                <h2 class="text-xl md:text-2xl font-bold text-black mb-6 text-left mt-12">What does your boat look like?</h2>
