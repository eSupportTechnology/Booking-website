        ...
        <div class="max-w-3xl mx-auto p-4 space-y-4 ">
            ...
            <div class="border border-gray-300 border rounded-lg p-4 flex justify-between items-center">
                <div class="flex items-center gap-4">
                    <img src="{{ asset('assets/flat-color-icons_ok.svg') }}" alt="Icon" class="w-6 h-6 md:w-7 md:h-7" />
                    <div>
                ...
                <a href="{{ route('partner.hotels.create.2') }}" class="text-sky-600 font-medium text-sm hover:underline">Edit</a>
            </div>
...
<div class="border border-gray-300 rounded-lg p-4 flex flex-col gap-6">
    ...
    <div class="space-y-4 ">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 border border-gray-200 rounded-lg shadow-sm bg-gray-100 ">
            <!-- Room Image -->
            <img src="{{ asset('images/room.jpg') }}" alt="Room Image" class="w-24 h-24 object-cover rounded-md" />
    ...
    <div class="text-right">
        ...
        <button class="mt-4  text-sky-600 text-sm font-semibold px-4 py-2 rounded border border-sky-300 hover:bg-sky-100">
            + Add another room
        </button></a>
    </div>
</div>
            ...
            <div class="border border-gray-300 rounded-lg p-4 flex justify-between items-center ">
                <div class="flex items-center gap-4">
                    <img src="{{ asset('assets/Vector (40).svg') }}" alt="Icon" class="w-4 h-4 md:w-5 md:h-5 cursor-pointer" />
                    <div>
       ...
       <a href="{{ route('partner.hotels.photos') }}" class="text-sky-600 font-medium text-sm hover:underline">Edit</a>
            ...
            <div class=" border border-gray-300 rounded-lg p-4 flex justify-between items-center">
                <div class="flex items-center gap-4">
                    <img src="{{ asset('assets/Vector (41).svg') }}" alt="Icon" class="w-4 h-4 md:w-5 md:h-5 cursor-pointer" />
                    <div>
     ...
     <a href="{{ route('partner.hotels.payments') }}" class="text-sky-600 font-medium text-sm hover:underline">Edit</a>
            </div>

        
        <div class="flex justify-center">
    <button class="mt-4 w-full  bg-[#3CC0E9] font-semibold text-white rounded hover:bg-sky-500 text-sm font-semibold px-6 py-2 rounded shadow">
