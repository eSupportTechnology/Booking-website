...
<body class="bg-gray-50 text-gray-800">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-12">
            ...
            <!-- Card 1 -->
            <div
                class="relative bg-white p-4 rounded-lg shadow border text-center flex flex-col items-center h-full justify-between">
                <!-- Badge -->
                <span
                    class="absolute -top-2 bg-green-700 text-white text-xs px-2 py-1 rounded-lg font-semibold z-10 inline-flex items-center space-x-1">
                ...
                <div class="flex flex-col flex-grow items-center space-y-4 mt-6">
                    ...
                    <p class="text-sm text-gray-600 text-center">Furnished and self-catering accommodation, where guests
                        rent the entire place.</p>
                </div>

                <a href="{{ url('/partner/property_subcategory/2') }}" class="w-[70%] mt-4 mb-2">
                    <button
                        class="bg-[#3CC0E9] hover:bg-[#29ACD5] text-white px-4 py-2 rounded text-sm font-semibold w-full">
                        List your property
                    </button>
                </a>
            </div>
            ...
            <div class="bg-white p-4 rounded-lg shadow border text-center flex flex-col w-full h-full justify-between">
                <div class="flex flex-col flex-grow items-center space-y-4 mt-6">
                    ...
                    <p class="text-sm text-gray-600 text-center">Properties like apartments, holiday homes, villas, etc.
                    </p>
                </div>
            ...
            <div class="bg-white p-4 rounded-lg shadow border text-center flex flex-col w-full h-full justify-between">
                <div class="flex flex-col flex-grow items-center space-y-4 mt-6">
                    ...
                    <p class="text-sm text-gray-600 text-center">Properties like hotels, B&Bs, guest houses, hostels,
                        aparthotels, etc.</p>
                </div>
                <a href="{{ route('partner.hotels.create.1') }}" class="mt-4 mb-2 w-[70%] mx-auto block">
                    <button
                        class="bg-[#3CC0E9] hover:bg-[#29ACD5] text-white px-4 py-2 rounded text-sm font-semibold w-full">
                        List your property
                    </button>
            ...
            <div class="bg-white p-4 rounded-lg shadow border text-center flex flex-col w-full h-full justify-between">
                <div class="flex flex-col flex-grow items-center space-y-4 mt-6">
                    ...
                    <p class="text-sm text-gray-600 text-center">Properties like boats, campsites, luxury tents, etc.
                    </p>
                </div>
                <button
                    class="mt-4 mb-2 bg-[#3CC0E9] hover:bg-[#29ACD5] text-white px-4 py-2 rounded text-sm font-semibold mx-auto w-[70%]">
                    List your property
                </button>
            </div>
...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-12">
    ...
    <div class="bg-white p-4 rounded-lg shadow border text-center flex flex-col w-full h-full justify-between">
      ...
      <a href="{{ url('/partner/property_subcategory/1') }}" class="mt-4 mb-2 bg-[#3CC0E9] hover:bg-[#29ACD5] text-white px-4 py-2 rounded text-sm font-semibold mx-auto w-[70%] text-center block">
        List your property
      </a>
    </div>
