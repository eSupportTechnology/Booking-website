                            ...
                            <div class="relative w-full max-w-md p-6 bg-white rounded-lg shadow">
                                ...
                                <div class="mt-4">
                                    <p class="mb-4 text-base text-gray-500"
                                        style="font-family: 'Noto Sans', sans-serif;">Suggested for you</p>
    ...
    <section class="max-h-screen flex items-start justify-center pt-10 px-4 sm:px-6">
        <div class="w-full max-w-md space-y-6">
            ...
            <div class="bg-white border border-gray-200 shadow-md rounded-md p-6 mt-8">
                ...
                <h2 class="text-xl font-semibold mb-2" style="font-family: 'Noto Sans', sans-serif;">Create your partner
                    account</h2>
                <p class="text-gray-600 text-sm mb-6" style="font-family: 'Noto Sans', sans-serif;">Create an account to
                    list and manage your property.</p>
