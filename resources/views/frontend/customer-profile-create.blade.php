                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="relative w-16 h-16">
                            ...
                            <label for="profile-upload"
                                ...
                                <img src="{{ asset('assets/mdi_camera-outline.svg') }}" alt="Stay"
                                    class="w-3 h-3" />
            ...
            ">
                            ...
                            <div x-show="editing === section" class="mt-1 mb-4 space-y-2">
                                ...
                                <template x-if="section === 'displayName'">
                                    <input type="text" x-model="completed.displayName"
                                        ...
                                        <div
                                            ...
                                            <select x-ref="countryCode"
                                                ...
                                                <option value="+94" data-flag="https://flagcdn.com/w40/lk.png"
                                                    selected>+94</option>
                                                <option value="+44" data-flag="https://flagcdn.com/w40/gb.png">+44
                                                </option>
                                                <option value="+49" data-flag="https://flagcdn.com/w40/de.png">+49
                                                </option>
                                                <option value="+1" data-flag="https://flagcdn.com/w40/us.png">+1
                                                </option>
                                            </select>
                                ...
                                <template x-if="section === 'passport'">
                                    <div class="space-y-4">
                                        ...
                                        <p class="text-xs text-gray-500">Please enter the name exactly as written on
