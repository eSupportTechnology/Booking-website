        ...
        <div class="bg-white rounded shadow-md w-full max-w-md p-6 sm:p-8 text-center mt-10">
            <div class="text-left mb-6">
                <h1 class="text-2xl font-semibold" style="font-family: 'Noto Sans', sans-serif;">Verify your email
                    address</h1>
                <p class="text-sm text-gray-700 mt-2" style="font-family: 'Noto Sans', sans-serif;">We’ve sent a
                    verification code to<br>
                    <span class="font-semibold"
                        style="font-family: 'Noto Sans', sans-serif;">www.sample256@gmail.com</span>. Please enter this
                    code to continue.
                </p>
            </div>
            ...
            <p class="text-sm text-gray-600 mt-4"style="font-family: 'Noto Sans', sans-serif;">Didn’t receive an email?
                Please check your spam folder or request another code in <strong>48 seconds</strong></p>
            <a href="#" class="block mt-4 text-blue-600 hover:underline text-sm"
                style="font-family: 'Noto Sans', sans-serif;">Back to sign in</a>

            <div class="mt-8 text-xs text-gray-500">
                <p style="font-family: 'Noto Sans', sans-serif;">By signing in or creating an account, you agree with
                    our
                ...
                <p class="mt-2"style="font-family: 'Noto Sans', sans-serif;">All rights reserved<br>Copyright (2025)
                    – {{ config('domains.app_name') }}™</p>
            </div>
        </div>
    </main>
