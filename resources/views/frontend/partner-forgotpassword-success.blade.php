...
<head>
  ...
  <title>Check your inbox | Bookintour</title>
...
<body class="bg-white">
  ...
  <section class="min-h-screen flex items-start justify-center pt-10 px-4 sm:px-6">
    <div class="w-full max-w-md">
      <div class="bg-white border border-gray-200 shadow-md rounded-md p-6 text-center">
        <h2 class="text-xl font-semibold mb-2" style="font-family: 'Noto Sans', sans-serif;">Check your inbox</h2>
        <p class="text-gray-700 text-sm mb-2" style="font-family: 'Noto Sans', sans-serif;">
          We've just emailed instructions and a reset password link to
        </p>
        <p class="font-semibold text-sm mb-6" style="font-family: 'Noto Sans', sans-serif;">
          b************@g****.com
        </p>

        <a href="/partner-signin" class="inline-block w-full text-center border border-blue-500 text-blue-600 font-semibold py-2 rounded hover:bg-blue-50 transition-colors duration-200" style="font-family: 'Noto Sans', sans-serif;">
          Back to sign-in
        </a>
        ...
        <p class="text-[11px] text-gray-400 mt-4" style="font-family: 'Noto Sans', sans-serif;">All rights reserved.</p>
        <p class="text-[11px] text-gray-400" style="font-family: 'Noto Sans', sans-serif;">Copyright (2006 – 2025) Bookintour.com™</p>
      </div>
    </div>
  </section>
