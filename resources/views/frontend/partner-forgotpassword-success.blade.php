...
<head>
    ...
    <title>Check your inbox | {{ config('domains.app_name') }}</title>
    ...
    <section class="min-h-screen flex items-start justify-center pt-10 px-4 sm:px-6">
        <div class="w-full max-w-md">
            <div class="bg-white border border-gray-200 shadow-md rounded-md p-6 text-center">
                <h2 class="text-xl font-semibold mb-2" style="font-family: 'Noto Sans', sans-serif;">Check your inbox
                </h2>
                ...
                <a href="/partner-signin"
                    class="inline-block w-full text-center border border-blue-500 text-blue-600 font-semibold py-2 rounded hover:bg-blue-50 transition-colors duration-200"
                    style="font-family: 'Noto Sans', sans-serif;">
                    Back to sign-in
                </a>
                ...
                <p class="text-[11px] text-gray-400 mt-4" style="font-family: 'Noto Sans', sans-serif;">All rights
                    reserved.</p>
                <p class="text-[11px] text-gray-400" style="font-family: 'Noto Sans', sans-serif;">Copyright (2006 –
                    2025) {{ config('domains.domain') }}™</p>
            </div>
        </div>
    </section>
