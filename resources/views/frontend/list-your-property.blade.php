    ...
    <div class="container px-4 md:px-8 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div class="w-full md:w-1/2 bg-white text-black p-6 rounded-lg border-4 border-yellow-400 shadow-md max-w-md">
            ...
            <button
                ...
                <a href="{{ url('partner/register/email') }}" class="block w-full h-full text-white">Get started now
                    →</a>
            </button>
            <p class="mt-4 text-sm">
                <span class="font-bold text-black">Already started a registration?</span><br>
                <a href="{{ url('partner/register/email') }}" class="text-[#3CC0E9] hover:underline">Continue your
                    registration</a>
            </p>
        </div>
    </div>
...
<section class="py-12 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-semibold text-gray-800 mb-8" style="font-family: 'Poppins', sans-serif;">Host
            worry-free. We've got your back</h2>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Column 1: Your rental, your rules -->
            <div>
                <h3 class="text-xl font-semibold mb-4" style="font-family: 'Noto Sans', sans-serif;">Your rental, your
                    rules</h3>
                ...
                <p class="text-sm text-gray-500 mt-2" style="font-family: 'Noto Sans', sans-serif;">*Currently
                    available for guest bookings made via iOS.</p>
            </div>
        ...
        <div
            ...
            <ul class="space-y-2 mb-4 text-sm">
                <li class="flex items-start">
                    ...
                    <span class="ml-2" style="font-family: 'Noto Sans', sans-serif;">45% of hosts get their first
                        booking within a week</span>
                </li>
                <li class="flex items-start">
                    <span class="text-green-600 font-bold" style="font-family: 'Noto Sans', sans-serif;">✓</span>
                    <span class="ml-2" style="font-family: 'Noto Sans', sans-serif;">Choose instant bookings or
                        Request to Book</span>
                </li>
                <li class="flex items-start">
                    <span class="text-green-600 font-bold" style="font-family: 'Noto Sans', sans-serif;">✓</span>
                    <span class="ml-2"style="font-family: 'Noto Sans', sans-serif;">We'll facilitate payments for
                        you</span>
                </li>
            </ul>
            <a href="#"
                class="block bg-sky-400 hover:bg-sky-500 text-white text-center font-semibold py-2 rounded-md transition"
                style="font-family: 'Noto Sans', sans-serif;">
                Get started now →
            </a>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-8 border-t border-white/30 pt-4 text-sm text-center text-white">
        <div class="flex flex-col md:flex-row justify-between items-center gap-2">
            ...
            <p class="mt-2 md:mt-0" style="font-family: 'Poppins', sans-serif;">© Copyright <a href="#"
                    class="underline" style="font-family: 'Poppins', sans-serif;">{{ config('domains.domain') }}</a>
                2025</p>
        </div>
    </div>
</footer>
