        ...
        <div>
            <div class="flex items-center gap-6 mb-4">
                <label class="inline-flex items-center">
                    <input type="radio" name="trip_type" value="one-way" class="form-radio text-blue-500" checked onclick="toggleReturnDate(false)">
                    <span class="ml-2">One-way</span>
                </label>
                <label class="inline-flex items-center">
                    <input type="radio" name="trip_type" value="return" class="form-radio text-blue-500" onclick="toggleReturnDate(true)">
                    <span class="ml-2">Return</span>
                </label>
            </div>
            
<form method="GET" class="bg-white rounded-xl px-2 py-1 shadow-lg flex flex-col md:flex-row items-center gap-1 md:gap-0 border-4 border-gray-200 w-full mx-auto overflow-visible text-sm">
  <div class="grid grid-cols-1 md:grid-cols-6 gap-4 items-center w-full">

    <!-- Pick-up location -->
    <input type="text" placeholder="Enter pick-up location" class="w-full px-3 py-2 border p-3 rounded outline-none" />

    <!-- Destination -->
    <input type="text" placeholder="Enter destination" class="w-full border p-3 rounded outline-none" />

    <!-- Pickup date and time -->
    <input type="datetime-local" class="w-full border p-3 rounded outline-none" />

    <!-- Return date -->
    <input type="datetime-local" id="return-date" disabled class="w-full border p-3 rounded outline-none text-gray-400 border-gray-300 bg-gray-100" />

    <!-- Users dropdown -->
    <select class="w-full border p-3 rounded outline-none">
    ...
    <!-- Search button -->
    <button class="bg-sky-500 text-white px-6 py-3 rounded hover:bg-sky-600 transition w-full">Search</button>
    ...
    <script>
        function toggleReturnDate(enable) {
            ...
            returnDateInput.disabled = !enable;
            returnDateInput.classList.toggle('text-gray-400', !enable);
            returnDateInput.classList.toggle('bg-gray-100', !enable);
            returnDateInput.classList.toggle('border-yellow-400', enable);
            returnDateInput.classList.toggle('border-gray-300', !enable);
        }
    </script>
</section>
