        ...
        <form class="p-6 rounded-lg space-y-6" @submit.prevent>
            ...
            <div x-show="step === 1" x-cloak>
                ...
                <div class="bg-white max-w-xl w-full p-6 rounded-lg shadow " x-data="{ selected: '' }">
                    ...
                    <label :class="selected === 'multiple' ? 'border-blue-600 border-2' : 'border border-gray-300'"
                        ...
                        <div class="flex items-center space-x-4">
                            <img src="{{ asset('images/accomm_private_room@2x.png') }}" alt="Multiple Apartments"
                                class="w-8 h-8" />
                            <div>
                                <span class="text-base font-bold text-gray-800">A private room</span>
                                <p class="text-xs text-gray-800">
                                    Guests rent a room within the property. There are common areas that are either
                                    shared with the host or other guests.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between pt-4">
                        <button type="button" @click="if(step > 1) step--"
                            ...
                            :disabled="step === 1" :class="step === 1 ? 'opacity-50 cursor-not-allowed' : ''">
                            ←
                        </button>
              ...
              { id: 'section-aparthotel', title: 'Aparthotel', desc: 'A self-catering apartment with some hotel facilities like a reception desk' }
                ...
                <template x-if="step === 2">
                    <div class="flex items-center justify-between pt-4">
                        ...
                        <button id="continueBtn" @click="if(selectedBox) { step = 3; }" :disabled="!selectedBox"
            ...
            <template x-if="step === 3">
                <div>
                        ...
                        <form class="p-6 rounded-lg" enctype="multipart/form-data" @submit.prevent>
                            ...
                            <template x-if="step === 1">
                                <div class="bg-white max-w-2xl w-full p-6 rounded-lg shadow space-y-6 ">
                                    <h2 class="text-xl font-bold text-left">How many holiday homes are you listing?
                                    </h2>
                    ...
                    <!-- Chalet -->
                    <section x-show="selectedBox === 'section-chalet'"
                        class="mt-20 p-8 bg-gray-100 rounded shadow-lg">
                    ...
                    <!-- Holiday Park -->
                    <section x-show="selectedBox === 'section-holiday-park'"
                        class="mt-20 p-8 bg-gray-100 rounded shadow-lg">
                    ...
                    <!-- Aparthotel -->
                    <section x-show="selectedBox === 'section-aparthotel'"
                        class="mt-20 p-8 bg-gray-100 rounded shadow-lg">
