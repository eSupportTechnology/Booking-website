...
<head>
    ...
    <title>Having Trouble Signing In? | {{ config('domains.app_name') }}</title>
    ...
    <main class="min-h-screen flex items-start justify-center pt-10 px-4 sm:px-6 mt-6">
        <div class="w-full max-w-md">
            <div class="bg-white border border-gray-200 shadow-md rounded-md p-6 text-center">
                <h2 class="text-xl font-semibold mb-2" style="font-family: 'Noto Sans', sans-serif;">Having trouble
                    signing in?</h2>
                ...
                <ul class="space-y-4 text-left">
                    <li class="flex items-center justify-between border-b pb-2">
                        <a href="/partner-forgot-password"
                            class="flex items-center text-blue-600 hover:underline space-x-2 font-medium">
                            <img src="{{ asset('assets/material-symbols-light_lock-outline.svg') }}" alt="Lock Icon"
                    ...
                    <li class="flex items-center justify-between border-b pb-2">
                        <a href="#" class="flex items-center text-blue-600 hover:underline space-x-2 font-medium">
                            <img src="{{ asset('assets/circum_user.svg') }}" alt="User Icon"
                                class="w-5 h-5 inline-block align-middle" />
                    ...
                    <li class="flex items-center justify-between">
                        <a href="/partner-signin"
                            class="flex items-center text-blue-600 hover:underline space-x-2 font-medium">
                            <img src="{{ asset('assets/material-symbols-light_logout.svg') }}" alt="Logout Icon"
                                class="w-5 h-5 inline-block align-middle" />
                ...
                <p class="text-[11px] text-gray-400">Copyright (2006 – 2025) {{ config('domains.domain') }}™</p>
            </div>
        </div>
    </main>
