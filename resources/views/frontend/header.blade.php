                ...
                <div class="flex items-center space-x-4">
                        ...
                        <div class="relative w-full max-w-md p-6 bg-white rounded-lg shadow dark:bg-gray-800">
                            ...
                            <div class="flex items-start justify-between">
                                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                                    {{-- @php
                                ($languages = ["en" => "English (UK)", "si" => "සිංහල (Sinhala)"]) --}}
                    ...
                    @auth('customer')
                        <form method="POST" action="{{ route('customer.logout') }}">
                            @csrf
                            <button type="submit" class="bg-white font-base px-4 py-2 rounded hover:bg-red-100"
                                style="font-family: 'Noto Sans', sans-serif; color:#EF4444;">
                                Logout
                            </button>
                        </form>
                    @else
