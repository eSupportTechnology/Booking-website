    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8 text-center sm:text-left">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('bookings.trips') }}" class="text-gray-500 hover:text-[#1F8FB2] transition-colors">Manage your Trips</a></li>
                    <li><a href="#" class="text-gray-500 hover:text-[#1F8FB2] transition-colors">Contact Customer Service</a></li>
                    <li><a href="#" class="text-gray-500 hover:text-[#1F8FB2] transition-colors">Safety Resource Center</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-gray-500 hover:text-[#1F8FB2] transition-colors">About {{ config('domains.app_name') }}</a></li>
                    <li><a href="#" class="text-gray-500 hover:text-[#1F8FB2] transition-colors">How We Work</a></li>
                    <li><a href="#" class="text-gray-500 hover:text-[#1F8FB2] transition-colors">Sustainability</a></li>
