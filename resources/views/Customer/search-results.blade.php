...
<style>
    ...
    .results-grid-container {
        ...
        gap: 1.5rem;
        /* space-y-6 equivalent in grid gap */
    }
    ...
    .results-grid-container .result-item .result-image {
        height: 200px;
        min-width: 100%;
        /* Image takes full width in grid item */
    }
    ...
    .results-grid-container .result-item .sm\:w-1\/4 {
        width: 100%;
        /* Price/CTA takes full width */
    }

    .results-grid-container .result-item .sm\:border-t-0 {
        border-top: 1px solid #f3f4f6;
        /* Re-add top border for separation in stacked layout */
        border-left: none;
        /* Remove left border */
    }
    ...
    .results-grid-container .result-item .sm\:items-end {
        ...
        /* Align price details to the start for better stack readability */
    }
...
<div class="relative z-10 -mt-8 px-2 sm:px-4 mb-6">
    <form id="search-form" action="{{ route('customer.search') }}" method="GET"
        ...
        <div x-data="{ open: false, adults: 2, children: 0, rooms: 1, pets: false }"
            ...
            <input type="hidden" name="adults" id="guests-adults" x-model="adults">
            <input type="hidden" name="children" id="guests-children" x-model="children">
            <input type="hidden" name="rooms" id="guests-rooms" x-model="rooms">
            <input type="hidden" name="pets" id="guests-pets" x-model="pets">
        </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="h-full overflow-y-auto p-4 border-r lg:border-none">
                ...
                <div class="mb-4" id="budget-filter-section">
                    <h3 class="font-semibold text-gray-700 mb-2 flex justify-between items-center cursor-pointer filter-toggle-header" data-target="budget-content">
                        ...
                        <svg class="w-4 h-4 text-gray-400 filter-toggle-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="mb-6" id="{{ $group['id_prefix'] }}-section">
                    <h3 class="font-bold text-lg text-gray-900 mb-2 flex justify-between items-center cursor-pointer filter-toggle-header" data-target="{{ $contentId }}">
                        {{ $group['title'] }}
                        <svg class="w-4 h-4 text-gray-400 filter-toggle-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </h3>
            ...
            <div class="lg:hidden mb-4">
                <button id="open-sidebar-btn" class="w-full py-3 bg-primary text-white font-bold rounded-lg shadow-lg flex items-center justify-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1v-2zM15 10a1 1 0 011-1h4a1 1 0 011 1v2a1 1 0 01-1 1h-4a1 1 0 01-1-1v-2zM3 16a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1v-2zM19 16a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 01-1 1h-2a1 1 0 01-1-1v-2z" />
                    </svg>
                    Filter Results
                </button>
            </div>
            ...
            <div class="bg-white p-4 rounded-xl shadow-lg border border-gray-100 mb-6">
                <div class="h-64 bg-gray-100 rounded-lg mb-4 flex items-center justify-center text-gray-400">
                    <svg class="w-8 h-8 mr-2" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 2a8 8 0 100 16 8 8 0 000-16zM4 10a6 6 0 1112 0 6 6 0 01-12 0zm10-3a1 1 0 00-1-1H7a1 1 0 00-1 1v6a1 1 0 001 1h6a1 1 0 001-1V7zm-2 2a1 1 0 00-1 1v2a1 1 0 102 0v-2a1 1 0 00-1-1z" clip-rule="evenodd" />
                    </svg>
                    Show on map
                </div>
                        ...
                        <div class="flex border rounded-lg overflow-hidden">
                            ...
                            <button id="list-view-btn" class="p-2 bg-gray-200 text-gray-800 transition-colors">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M1 4h18v2H1V4zm0 6h18v2H1v-2zm0 6h18v2H1v-2z" />
                                </svg>
                            </button>
                            {{-- Grid View Button --}}
                            <button id="grid-view-btn" class="p-2 hover:bg-gray-100 transition-colors">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 3a1 1 0 00-1 1v12a1 1 0 102 0V4a1 1 0 00-1-1zm-6 4a1 1 0 011-1h2a1 1 0 011 1v8a1 1 0 11-2 0V7H5a1 1 0 01-1-1zm10-1a1 1 0 00-1 1v8a1 1 0 102 0V7a1 1 0 00-1-1z" />
                                </svg>
                            </button>
                        </div>
                    </div>
    ...
    <div class="mt-8 flex justify-center">
        <p class="text-center text-gray-500">End of results.</p>
    </div>
    </main>
