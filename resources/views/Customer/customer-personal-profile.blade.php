                        ...
                        <div class="border-t pt-4 min-h-[100px] flex flex-col justify-center">
                            ...
                            <div class="flex justify-between items-start md:items-center">
                                ...
                                <button
                                    ...
                                    :class="{
                                        'text-blue-600 hover:underline text-sm': editing === null && (index === 0 ||
                                            completed[Object.keys(completed)[index - 1]]),
                                        'opacity-50 cursor-not-allowed text-sm': editing !== null || (index > 0 && !
                                            completed[Object.keys(completed)[index - 1]])
                                    }"
                            ...
                            <form method="POST" action="{{ route('customer.details.store') }}"
                                ...
                                <div x-show="editing === section" class="mt-1 mb-4 space-y-2">
                                    ...
                                    <template x-if="section === 'displayName'">
                                        <input type="text" name="display_name" id="display_name" placeholder="Choose a display name"
                                            class="w-full border border-gray-300 rounded-md px-3 py-3 text-sm"
                                    ...
                                    <template x-if="section === 'emailAddress'">
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500 mt-1">
                                                We'll send a verification link to your new email address. Please check
                                                your
                                                inbox.
                                            </p>
                                        </div>
                                    ...
                                    <template x-if="section === 'phone'">
                                        <div class="space-y-2">
                                            ...
                                            <div
                                                ...
                                                <!-- Flag Image -->
                                                <img id="selected-flag" src="https://flagcdn.com/w40/lk.png"
                                                    alt="Flag" class="w-6 h-4 rounded" />
                                    ...
                                    <template x-if="section === 'nationality'">
                                        <select class="w-full border border-gray-300 rounded-md px-3 py-3 text-sm"
                                            ...
                                            <option value="LK" {{ old('nationality', $nationality ?? '') == 'LK' ? 'selected' : '' }}>Sri Lanka</option>
                                            <option value="US" {{ old('nationality', $nationality ?? '') == 'US' ? 'selected' : '' }}>United States</option>
                                            <option value="GB" {{ old('nationality', $nationality ?? '') == 'GB' ? 'selected' : '' }}>United Kingdom</option>
                                        </select>
                                    </template>
                                    ...
                                    <template x-if="section === 'gender'">
                                        <select class="w-full border border-gray-300 rounded-md px-3 py-3 text-sm"
                                            ...
                                            <option value="non-binary" {{ old('gender', $gender ?? '') == 'non-binary' ? 'selected' : '' }}>Non-binary</option>
                                        </select>
                                    </template>
                                    ...
                                    <div class="flex justify-end space-x-4 mt-2">
                                        ...
                                        <button @click="completed[section] = true; editing = null"
                                            class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 text-sm font-medium">Save</button>
                                    </div>
                                </div>
                            </form>
                        </div>
