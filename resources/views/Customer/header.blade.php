    ...
    <section class="py-4">
        <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center flex-wrap space-y-4 md:space-y-0">
                ...
                <!-- Right Section -->
                <div class="flex items-center flex-wrap gap-3 md:gap-5 mt-2 md:mt-0">

                    <!-- Currency -->
                    <div class="flex items-center space-x-1">
                        <span id="current-currency" class="font-semibold cursor-pointer select-none" title="Click to change currency">LKR</span>
                    </div>
                    ...
                    <a href="#" class="flex items-center">
                        <img src="{{ asset('assets/question.svg') }}" alt="Help" class="w-5 h-5 cursor-pointer" />
                    </a>
                    ...
                    @else
                        <div class="flex items-center gap-2">
                            <a href="{{ route('customer.login') }}"
                               class="bg-white font-base px-3 py-1 md:px-4 md:py-2 rounded hover:bg-blue-100 text-sm md:text-base"
